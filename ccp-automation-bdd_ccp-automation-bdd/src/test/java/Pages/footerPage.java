...
public class footerPage {
	...
	By accSetting = By.xpath("//section/div[3]/div[1]/div/ul/li[7]/a");
	By accDomains = By.xpath("//section/div[3]/div[1]/div/ul/li[8]/a");
	By accInformation = By.xpath("//section/div[3]/div[1]/div/ul/li[11]/a");
	By addOfUse = By.xpath("//section/div[3]/div[1]/div/ul/li[4]/a");
	By budget = By.xpath("//section/div[3]/div[1]/div/ul/li[5]/a");
	By catalogRestrictions = By.xpath("//section/div[3]/div[1]/div/ul/li[6]/a");
	By NotificationManagement = By.xpath("//section/div[3]/div[1]/div/ul/li[9]/a");
	By paymentMethod = By.xpath("//section/div[3]/div[1]/div/ul/li[10]/a");
	public footerPage() {
	...
	public void VerifyOptionAccountInfoFromAccMenu() {
		if (common_func.isElementPresent(common_func.getOnLinkText("My Profile"))) {
			...
			if (common_func.isElementPresent(common_func.getOnLinkText("Notification Management"))) {
				System.out.println(common_func.getOnLinkText("Notification Management").getText());
				if (common_func.isElementPresent(common_func.getOnLinkText("Payment Method"))) {
					System.out.println(common_func.getOnLinkText("Payment Method").getText());
					if (common_func.isElementPresent(common_func.getOnLinkText("User Management"))) {
						System.out.println(common_func.getOnLinkText("User Management").getText());
					}
				}
			}
		}
	...
	public void VerifyOptionsAccountMenuAccessRequest() {
		if (common_func.isElementPresent(common_func.getOnLinkText("My Profile"))) {
			System.out.println(common_func.getOnLinkText("My Profile").getText());
			...
			if (common_func.isElementPresent(common_func.getOnLinkText("Logout"))) {
				System.out.println(common_func.getOnLinkText("Logout").getText());
			}
			if(common_func.isElementPresentBy(accDomains)) {
				System.out.println("Account Domains");}
				if(common_func.isElementPresentBy(accSetting)) {
					System.out.println("Account Settings");}
					if(common_func.isElementPresentBy( NotificationManagement)) {
					System.out.println("Notification Management");}
						if(common_func.isElementPresentBy(addOfUse)) {
							System.out.println("Address of Use");}
							if(common_func.isElementPresentBy(paymentMethod)) {
								System.out.println("Payment Method");}
								if(common_func.isElementPresentBy(catalogRestrictions)) {
									System.out.println("Catalog Restrictions");}
									if(common_func.isElementPresentBy(accInformation)) {}
