...
Feature: Verify report and Setup tabs on management portal  website
 ...
 Background:
  ...
  @CreateUserElements @Smoke @createUser_smoke_002
   ...
   @CreateUserPage @Smoke @createUser_smoke_001 
    Scenario Outline: To verify all elements of create user Page. (buttons,links,fields,etc)
    When User clicks on User tab
    Then User reaches on page "<pageTitle>"
    Examples:
  ...
  @RolepageElememnts @Smoke @roles_smoke_002
  ...
  @EditRole @Smoke  @roles_smoke_003
  ...
  @CreateRole @Smoke  @roles_smoke_004
    Scenario Outline: To edit the current role
   When User clicks on User tab
   Then User reaches on page "<pageTitle>"
   When User hovers on User tab
  ...
  @changePasswordElements @Smoke @changePass_smoke_002
  ...
  @changePasswordPage @Smoke @changePass_smoke_001 
    Scenario Outline: To verify the redirection by clicking My Account (My Account<Change Password )
    When User clicks on change password from account menu
    Then User reaches on page "<pageTitle>"
    Examples:
      |pageTitle            |
