...
Feature: Verify management portal  website
 ...
 @MLoginPageElements @Smoke @login_smoke_002  @login_smoke_003  @login_smoke_004  @login_smoke_005  @login_smoke_006  @login_smoke_007
    Scenario Outline: Verifies the presence of elements on login page.
    Then User logs out
  ...
  @MforgotPasswordPageSmoke @Smoke @forgotPassword_smoke_003
   ...
   @MforgotPasswordElementsSmoke @Smoke @forgotPassword_smoke_001 @forgotPassword_smoke_002
